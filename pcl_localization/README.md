# pcl_localization
![CI](https://github.com/rsasaki0109/pcl_localization/workflows/CI/badge.svg)  
...
```
rviz2 -d src/pcl_localization/rviz/localization.rviz
ros2 launch pcl_localization pcl_localization.launch.py
